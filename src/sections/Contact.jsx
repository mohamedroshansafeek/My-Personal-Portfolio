...
export const Contact = () => {
    ...
    >
      <RevealOnScroll>
         <div className="px-4 w-full sm:w-[400px] md:w-[600px] lg:w-[800px]">
            <h2 className="max-w-3xl text-4xl font-semibold mb-12 bg-gradient-to-r from-teal-500 to-indigo-600 bg-clip-text text-transparent text-center ">
              Get In touch
            </h2>

            <form action="https://formsubmit.co/mohamedroshansafeeky@gmail.com" method="POST" className="space-y-6">
